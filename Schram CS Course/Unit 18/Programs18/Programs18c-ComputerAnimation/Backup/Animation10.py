# Animation10.py
# This program properly animates the car 
# across the screen by placing all 4 shapes 
# in the same <for> loop.
# A little algebra is required since the 
# location of 3 of the shapes is relative 
# to the location of the rear wheel.
# This program also introduces another issue.  
# As more and more images are drawn/erased 
# on/from the screen, the output gets slower 
# and slower and eventually drags to a crawl.
