# Animation09.py
# This program demonstrates a common logic 
# error when students try to move complicated 
# images across the screen.
# The problem is each part of the car is in 
# its own separate loop.  This means each part 
# of the car moves across the screen one at a 
