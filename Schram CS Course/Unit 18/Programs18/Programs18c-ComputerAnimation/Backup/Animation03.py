# Animation03.py
# This program erases every circle before it 
# draws the next one.  This is necessary for 
# animation; however, the process happens so 
# fast that you cannot see the circle move.
