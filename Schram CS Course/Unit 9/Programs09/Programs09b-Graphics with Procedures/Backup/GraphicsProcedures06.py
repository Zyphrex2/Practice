# GraphicsProcedures06.py
# This program adds 2 more procedures for drawing a 
# background.  When you run the program, all you see is
# the background.  This is because the background was 
# drawn after, and therefore on top of, everything else.
